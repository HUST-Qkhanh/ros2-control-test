#include "amr_robot_hardware/amr_system.hpp"
#include <chrono>
#include <cmath>
#include <limits>
#include <memory>
...
#include <fcntl.h>
#include <termios.h>
#include "amr_robot_hardware/config.h"
...
namespace amr_robot_hardware
{
  ...
  DiffBotSystemHardware::DiffBotSystemHardware() : node("hoverboard")
  {
    last_read = node.now();
    ...
    // Init PID controller
    pids[0].init(&node_left, 1.0, 0.5, 0.2, 0.01, 1.5, -1.5, false, max_velocity, -max_velocity);
    pids[0].setOutputLimits(-max_velocity, max_velocity);
    pids[1].init(&node_right, 1.0, 0.8, 0.2, 0.01, 1.5, -1.5, false, max_velocity, -max_velocity);
  ...
  // ====================================================================================================
  // Function will configure the hardware interface
  // ====================================================================================================
  CallbackReturn DiffBotSystemHardware::on_init(const hardware_interface::HardwareInfo &info)
  {
    ...
    if (hardware_interface::SystemInterface::on_init(info) != CallbackReturn::SUCCESS)
    {
      RCLCPP_FATAL(
          ...
          "Failed to configure default interface");
    ...
    RCLCPP_FATAL(
        rclcpp::get_logger("DiffBotSystemHardware"),
        "Configured %zu joints", info_.joints.size());
  ...
  // ====================================================================================================
  //  Function will export the state interfaces
  // ====================================================================================================
  ...
  std::vector<hardware_interface::StateInterface> DiffBotSystemHardware::export_state_interfaces()
  {
    ...
    for (auto i = 0u; i < info_.joints.size(); i++)
    {
      state_interfaces.emplace_back(hardware_interface::StateInterface(
          info_.joints[i].name, hardware_interface::HW_IF_POSITION, &joints[i].pos.data));
      state_interfaces.emplace_back(hardware_interface::StateInterface(
          info_.joints[i].name, hardware_interface::HW_IF_VELOCITY, &joints[i].vel.data));
    }
  ...
  // ====================================================================================================
  // Function will export the command interfaces
  // ====================================================================================================
  ...
  std::vector<hardware_interface::CommandInterface> DiffBotSystemHardware::export_command_interfaces()
  {
    ...
    for (auto i = 0u; i < info_.joints.size(); i++)
    {
      command_interfaces.emplace_back(hardware_interface::CommandInterface(
          info_.joints[i].name, hardware_interface::HW_IF_VELOCITY, &joints[i].cmd.data));
    }
  ...
  // ====================================================================================================
  // Function will read the data from the hardware
  // ====================================================================================================

  void DiffBotSystemHardware::protocol_recv(char byte)
  {
    ...
    if (msg_len == sizeof(SerialFeedback))
    {
      ...
      if (msg.start == START_FRAME && msg.checksum == checksum)
      {
        ...
        joints[0].vel.data = -direction_correction * ((msg.speedL_meas) * 0.10472);
        joints[1].vel.data = direction_correction * ((msg.speedR_meas) * 0.10472);
  ...
  // ====================================================================================================
  // Function will write the commands to the hardware
  // ====================================================================================================

  hardware_interface::return_type amr_robot_hardware::DiffBotSystemHardware::write()
  {
    // TODO: Throttle log
    ...
    const double steer = (set_speed[0] - set_speed[1]);
  ...
  // ====================================================================================================
  // Function will update the odometry
  // ====================================================================================================

  void DiffBotSystemHardware::on_encoder_update(int16_t right, int16_t left)
  {
    ...
    if ((node.now() - last_read).seconds() > 0.2 && abs(posL) < 5 && abs(posR) < 5)
    {
      lastPosL = posL;
      lastPosR = posR;
    }
...
// Include this macro to make your system component available to be loaded
#include "pluginlib/class_list_macros.hpp"
PLUGINLIB_EXPORT_CLASS(
    amr_robot_hardware::DiffBotSystemHardware, hardware_interface::SystemInterface)
